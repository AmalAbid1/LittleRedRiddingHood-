...
char image1Path[] = "C:/Users/ames8/Desktop/ppp.bmp";
...
void init3() {
    ...
    // Set background color to black and opaque”„«ÊÌ
     //  
...
void special(int key, int x, int y) //THIS IS THE GIRL BASIC MOVEMENT KEYS CODE :JUMANA
{
    ...
    case GLUT_KEY_RIGHT:
        ...
        gx += 0.1;
        cout << "girl in x " << gx << endl;
        cout << "girl in y " << gy << endl;
...
void homeTect() {
    ...
    glBegin(GL_QUADS);
    glTexCoord2f(0.0, 0.135); glVertex3f(0.18, 0.1, 0.5);
    glTexCoord2f(1.0, 0.0); glVertex3f(0.48, 0.1, 0.5);
    glTexCoord2f(1.0, 0.99); glVertex3f(0.48, 0.3, 0.5);
    glTexCoord2f(0.0, 0.99); glVertex3f(0.18, 0.3, 0.5);
